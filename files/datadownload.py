...
#    train_y = tf.keras.utils.to_categorical(train_y, num_classes=58)
#    val_y = tf.keras.utils.to_categorical(val_y, num_classes=58)
#
#    print("")
...
#    return (train_X,train_y), (val_X,val_y)
    ...
    # one-hot encode the labels
    test_y = tf.keras.utils.to_categorical(test_y, num_classes=58)
    ...
    return (test_X,test_y), (test_X,test_y)
